          ...
          <div className='flex flex-col gap-5 lg:flex-row lg:justify-between'>
            ...
            <div className='bg-brand-light h-[325px] flex flex-col justify-between p-5 lg:w-full'>
              <div className='flex justify-between items-center'>
                ...
                <img className='h-9' src="./home/card/Bpm Logo.svg" alt="" />
              </div>
              <div>
            ...
            <div className='bg-brand-light h-[325px] flex flex-col justify-between p-5 lg:w-full'>
              <div className='flex justify-between items-center'>
                ...
                <img className='h-8' src="./home/card/38Fule Logo.svg" alt="" />
              </div>
              <div>
            ...
            <div className='bg-brand-light h-[325px] flex flex-col justify-between p-5 lg:w-full'>
              <div className='flex justify-between items-center'>
                <div className='p-3 bg-white rounded-lg'><img src="./home/card/Zhong Hai.svg" alt="" /></div>
                <img className='h-12' src="./home/card/Zhong Hai Logo.png" alt="" />
              </div>
              <div>
        ...
        <div className='relative w-full overflow-hidden py-10 border-t border-brand-light lg:py-20'>
          ...
          <div className='flex whitespace-nowrap pause-on-hover overflow-hidden'>
            <div className='flex gap-16 items-center animate-marquee shrink-0 min-w-full justify-around pr-16'>
              <img className='h-7 md:h-7 w-auto object-contain grayscale hover:grayscale-0 opacity-60 hover:opacity-100 transition-all duration-300' src="./home/card/38Fule Logo.svg" alt="38Fule Logo" />
              <img className='h-13 md:h-13 w-auto object-contain grayscale hover:grayscale-0 opacity-60 hover:opacity-100 transition-all duration-300' src="./home/card/Bpm Logo.png" alt="BPM Logo" />
              <img className='h-9 md:h-9 w-auto object-contain grayscale hover:grayscale-0 opacity-60 hover:opacity-100 transition-all duration-300' src="./home/card/Zhong Hai Logo.png" alt="Zhong Hai Logo" />
